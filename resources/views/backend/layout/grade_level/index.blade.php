...
@section('title', 'Grade level List')
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Grade Level List</h4>
                        <div style="display: flex;justify-content: end;">
                            <a href="{{ route('admin.category.create') }}"  class="btn btn-primary">Add Grade</a>
                        </div>
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                let dTable = $('#data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('admin.grade-level.index') }}",
                        type: "get",
                    },
        ...
        const deleteAuction = (id) => {
            try {
                let url = '{{ route('admin.grade-level.destroy', ':id') }}';
        ...
        function statusChange(id) {
            var url = '{{ route('admin.grade-level.status', ':id') }}';
            url = url.replace(':id', id);
